...
Ten thousand callers asking for the same cold key share one loader call. That behaviour is on by default and is described in [stampede protection](/docs/guides/stampede-protection).
...
<Columns cols={2}>
  ...
  <Card title="Execution paths" icon="git-branch" href="/docs/architecture/execution-paths">
