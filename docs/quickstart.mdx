---
title: "Quickstart"
description: "Run a cache, connect Redis, and add reads and invalidation to your application."
icon: "rocket"
---

Start with a runnable L1 cache, then connect the same API to Redis. You need Node.js 20 or 22+. The first example needs no database or Redis.
