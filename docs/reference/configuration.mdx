...
<ParamField path="inflight.ttlMs" type="number" default="derived">
...
<ParamField path="distributedLock.waitTimeoutMs" type="number" default="derived">
...
<ParamField path="distributedLock.onTimeout" type="string" default="throw">
