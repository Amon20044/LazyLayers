---
title: "L1/L2 cache system design"
description: "Design a hybrid Node.js cache with in-memory L1 and Redis L2: trade-offs, sizing, TTLs, and when each layer is the right fit."
icon: "layer-group"
---
...
flowchart TB
    ...
    B -->|no| C{L2 hit?}
    C -->|yes| P[promote if local budget permits] --> R
