...
<ParamField path="levels.L1" type="{ maxEntries?: number; ttlMs?: number; maxMemory?: MemoryLimit; minMemory?: MemoryLimit; autoEvict?: { enabled?: boolean }; admission?: { enabled?: boolean; maxEntryBytes?: number } }">
...
<ParamField path="memoryBudget" type="MemoryBudget">
...
<ParamField path="originLoad" type="{ enabled?: boolean; maxConcurrent?: number; maxQueued?: number; queueTimeoutMs?: number }">
...
<ParamField path="failSafe.maxEntries" type="number">
  Caps retained stale fallbacks. Defaults to `1000`.
</ParamField>

<ParamField path="failSafe.maxBytes" type="number">
...
<ParamField path="resilience.l2OperationGate" type="{ maxConcurrent?: number; maxQueued?: number; maxQueuedBytes?: number; queueTimeoutMs?: number; operationTimeoutMs?: number }">
