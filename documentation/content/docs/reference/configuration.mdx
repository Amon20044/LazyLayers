...
export const cache = await setupCache<string, User>(options)
```
</CodeGroup>
...
<ParamField path="negativeCache.ttlMs" type="number" default="10000">
...
<ParamField path="negativeCache.maxEntries" type="number" default="10000">
  Caps remembered misses. Eviction here is oldest-inserted, not LRU.
</ParamField>

<ParamField path="distributedLock.enabled" type="boolean" default="true">
...
<ParamField path="failSafe.enabled" type="boolean" default="true">
...
<ParamField path="timeouts.hardMs" type="number" default="10000">
