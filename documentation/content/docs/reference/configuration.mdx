...
Read [transaction coordination](/docs/reference/transactions) before using the API. It defines the required durable-record, provider-idempotency, reconciliation, and transactional-outbox responsibilities.
